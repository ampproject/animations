...
describe('getPositioningTranslate', () => {
    ...
    describe('top/left', () => {
        ...
        it('should return the correct value for calc offsets', () => {
            const position = getComputedObjectPosition('top calc(10% - 2px) left calc(10% - 2px)');
            const { top, left } = getPositioningTranslate(position, {
                width: 100,
                height: 100,
            }, {
    ...
    describe('bottom/right', () => {
        ...
        it('should return the correct value for calc offsets', () => {
            const position = getComputedObjectPosition('bottom calc(10% + 2px) right calc(10% + 2px)');
            const { top, left } = getPositioningTranslate(position, {
                width: 100,
                height: 100,
            }, {
...
//# sourceMappingURL=test-object-position.js.map